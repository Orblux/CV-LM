...
\personal
    [Permis B]
    {6, rue Casteret, 64\,000 Pau}
    {+33(0)6.30.74.27.36}
    {kevin.alazet@gmail.com}
    
\section{Education}
\begin{yearlist}
\item[Diplôme d'ingénieur chimique]{2014-2017}
     {Département Chimie et spécialité en Ingénierie Analytique}
     {\'Ecole Nationale Supérieur des Ingénieurs en Arts Chimiques Et Technologiques (ENSIACET), Toulouse}
\item{2011-2014}
     {Classe préparatoire PCSI, PC, PC*}
     {Lycée Charlemagne, Paris}
\item[Baccalauréat Série Scientifique]{Juin 2011}
